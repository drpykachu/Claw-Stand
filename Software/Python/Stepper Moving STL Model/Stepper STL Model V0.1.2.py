...
delta_Z     = 0   # Dropping from path for reset 
...
# print('   MIN     Max')
# print('A: %.2f, %2.f' % (np.min(minmax_a*180/3.14), np.max(minmax_a*180/3.14)))
# print('B: %.2f, %2.f' % (np.min(minmax_b*180/3.14), np.max(minmax_b*180/3.14)))
# print('C: %.2f, %2.f' % (np.min(minmax_c*180/3.14), np.max(minmax_c*180/3.14)))
print()
print('MAX - MIN')
...
print()
print('STEPS')
print('A: %.4f' % ((np.max(minmax_a*180/3.14) - np.min(minmax_a*180/3.14))/minstep))
print('B: %.4f' % ((np.max(minmax_b*180/3.14) - np.min(minmax_b*180/3.14))/minstep))
print('C: %.4f' % ((np.max(minmax_c*180/3.14) - np.min(minmax_c*180/3.14))/minstep))
