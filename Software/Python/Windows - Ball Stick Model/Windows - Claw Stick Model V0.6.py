...
def update(val):
    ...
    for k in range(num_fingers):
        ...
        if k == 0:
            Xtar, Ytar, Ztar = Xtar, Ytar, Ztar-3
        ...
        X_tar_text,Y_tar_text = rotate((0,0), (Xtar_new+5, Ytar_new+5),Offset_theta)
        ax.text(X_tar_text, Y_tar_text, Ztar_new, str(k+1), color='c')
