...
minstep     = 360/4096*20    # stepper motor step angle
minstep     = 0.001    # stepper motor step angle
...
plt.figure()
plt.plot(range(points),t_a,'red',label = 'Motor A v0.1')
plt.plot(range(points),t_b,'orange',label = 'Motor B v0.1')
plt.plot(range(points),t_c,'yellow',label = 'Motor C v0.1')
...
plt.plot(range(points),t_a,'blue',label = 'Motor A v0.2')
plt.plot(range(points),t_b,'cyan',label = 'Motor B v0.2')
plt.plot(range(points),t_c,'green',label = 'Motor C v0.2')
